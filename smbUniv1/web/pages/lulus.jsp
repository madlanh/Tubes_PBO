<%-- 
    Document   : lulus
    Created on : Dec 24, 2024, 8:02:04 PM
    Author     : ARMAGEDON
--%>
    ...
    <div class="container">
        ...
        <div class="content">
            <div class="img-container">
                <img src="images/lolos.png" alt="Ilustrasi Kelulusan">
            </div>
            <div class="text-container">
                <p class="fs-1 text-center fw-bold">SELAMAT!</p>
                <p class="text-center fs-3">Anda telah <br>
